    ...
    <style>
      ...
      <div class="col-md-12 col-sm-12">
        <div class="dashboard_graph">
            ...
            <hr>
            <form method="POST"id="editPasswordForm" action="{{ route('editpassword.updateee',['encodedId' => base64_encode($siswa->siswa_id)]) }}">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="text" class="form-control" name="username" placeholder="username"
                                value="{{ $siswa->listakunsiswa->username }}"  maxlength="50"
                                    readonly></td>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input type="password" class="form-control" name="password" id="password" placeholder="Password" maxlength="12" value="{{ $siswa->listakunsiswa->password }}"  {{ old('updatePassword') ? '' : 'disabled' }}>
                ...
                <button type="button" onclick="window.location.href = '{{ route('siswaall.show', ['encodedId' => base64_encode($siswa->siswa_id)]) }}'" class="btn btn-danger">Kembali</button>
                <script>
