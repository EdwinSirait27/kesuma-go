    ...
    <div class="col-md-12 col-sm-12">
        <div class="dashboard_graph">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <a href="{{ route('editpasswordguru.index', ['encodedId' => base64_encode($guru->guru_id)]) }}"
                    class="btn btn-dark">Edit Password</a>
            </div>



            <hr>
            <form method="POST" action="{{ route('guruall.updatee', ['encodedId' => base64_encode($guru->guru_id)]) }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input value="{{ $guru->Nama }}" type="text" class="form-control" id="Nama" name="Nama"
                            placeholder="Nama" maxlength="50">
                    </div>
                    <label for="TempatLahir" class="col-sm-2 col-form-label">Tempat Lahir</label>
                    <div class="col-sm-4">
                        <input value="{{ $guru->TempatLahir }}" type="text" class="form-control" id="TempatLahir"
                            name="TempatLahir" placeholder="Tempat Lahir" maxlength="30" required
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input value="{{ $guru->TanggalLahir }}"type="date" class="form-control" id="TanggalLahir"
                    ...
                    <div class="col-sm-4">
                        <select class="form-control select-field" id="Agama" name="Agama" required>
                            ...
                            <option value="Kristen Protestan" {{ $guru->Agama == 'Kristen Protestan' ? 'selected' : '' }}>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <select class="form-control select-field" id="StatusPegawai" name="StatusPegawai" required>
                            ...
                            <option value="PNS YDP" {{ $guru->StatusPegawai == 'PNS YDP' ? 'selected' : '' }}>PNS YDP
                            </option>
                            <option value="GTT" {{ $guru->GTT == 'GTT' ? 'selected' : '' }}>GTT</option>
                            <option value="Honorer" {{ $guru->StatusPegawai == 'Honorer' ? 'selected' : '' }}>Honorer
                            </option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input value="{{ $guru->Nik }}"type="text" class="form-control" id="Nik"
                    ...
                    <div class="col-sm-4">
                        <input value="{{ $guru->Npwp }}"type="text" class="form-control" id="Npwp"
                ...
                <div class="form-group row">
                    <label for="NomorSertifikatPendidik" class="col-sm-2 col-form-label">Nomor Sertifikat
                        Pendidik</label>
                    <div class="col-sm-4">
                        <input value="{{ $guru->NomorSertifikatPendidik }}"type="text" class="form-control"
                            id="NomorSertifikatPendidik" name="NomorSertifikatPendidik"
                    ...
                    <div class="col-sm-4">
                        <input value="{{ $guru->TahunSertifikasi }}"type="date" class="form-control"
                            id="TahunSertifikasi" name="TahunSertifikasi" placeholder="Tahun Sertifikasi" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input value="{{ $guru->pangkatgt }}"type="text" class="form-control" id="pangkatgt"
                            name="pangkatgt" placeholder="Pangkat"required>

                    </div>
                    <label for="jadwalkenaikanpangkat" class="col-sm-2 col-form-label">Jadwal Kenaikan Pangkat</label>
                    <div class="col-sm-4">
                        <input value="{{ $guru->jadwalkenaikanpangkat }}" type="date" class="form-control"
                            id="jadwalkenaikanpangkat" name="jadwalkenaikanpangkat"
                            placeholder="Jadwal Kenaikan Pangkat"required>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input value="{{ $guru->jadwalkenaikangaji }}"type="date" class="form-control"
                            id="jadwalkenaikangaji" name="jadwalkenaikangaji" placeholder="Jadwal Kenaikan Gaji"required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input value="{{ $guru->TMT }}"type="date" class="form-control" id="TMT"
                            name="TMT" placeholder="Tanggal Mulai Tugas">

                    </div>
                    <label for="PendidikanAkhir" class="col-sm-2 col-form-label">Pendidikan Akhir</label>
                    <div class="col-sm-4">
                        <input value="{{ $guru->PendidikanAkhir }}"type="PendidikanAkhir" class="form-control"
                            id="PendidikanAkhir" name="PendidikanAkhir" placeholder="Pendidikan Akhir"maxlength="5"
                            required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="date" value="{{ $guru->TahunTamat }}"class="form-control" id="TahunTamat"
                            name="TahunTamat" placeholder="Tahun Tamat"required>

                    </div>
                    <label for="Jurusan" class="col-sm-2 col-form-label">Jurusan</label>
                    <div class="col-sm-4">
                        <input type="Jurusan" value="{{ $guru->Jurusan }}"class="form-control" id="Jurusan"
                            name="Jurusan" placeholder="Jurusan"maxlength="50" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="TugasMengajar" value="{{ $guru->TugasMengajar }}"class="form-control"
                            id="TugasMengajar" name="TugasMengajar" placeholder="Tugas Mengajar"maxlength="50" required>

                    </div>
                    <label for="TugasTambahan" class="col-sm-2 col-form-label">Tugas Tambahan</label>
                    <div class="col-sm-4">
                        <input type="TugasTambahan" value="{{ $guru->TugasTambahan }}"class="form-control"
                            id="TugasTambahan" name="TugasTambahan" placeholder="Tugas Tambahan"maxlength="50" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="JamPerMinggu" value="{{ $guru->JamPerMinggu }}"class="form-control"
                            id="JamPerMinggu" name="JamPerMinggu" placeholder="Jam Per Minggu"maxlength="30" required>

                    </div>
                    <label for="TahunPensiun" class="col-sm-2 col-form-label">Tahun Pensiun</label>
                    <div class="col-sm-4">
                        <input type="date" value="{{ $guru->TahunPensiun }}"class="form-control" id="TahunPensiun"
                            name="TahunPensiun" placeholder="Tahun Pensiun"required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input value="{{ $guru->NomorTelephone }}"type="text" class="form-control" id="NomorTelephone"
                            name="NomorTelephone" placeholder="Nomor Telephone"
                            oninput="this.value = this.value.replace(/[^0-9]/g, '');"maxlength="13" required>
                    </div>
                    <label for="Alamat" class="col-sm-2 col-form-label">Alamat</label>
                    <div class="col-sm-4">
                        <input value="{{ $guru->Alamat }}"type="Alamat" class="form-control" id="Alamat"
                            name="Alamat" placeholder="Alamat"maxlength="40" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        ...
                        @if ($guru->foto)
                            <img src="{{ asset('storage/fotoguru/' . $guru->foto) }}" alt="Foto Profil" width="200"
