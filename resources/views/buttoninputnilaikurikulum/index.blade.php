...
@section('content')
    @include('buttoninputnilaikurikulum.create')
    <style>
        .table th,
        .table td {
            text-align: center;
    ...
    <div class="row" id="hal_index">
        <div class="card-header bg-dark text-white">
            <h3><i class="fa fa-book"style="margin-right: 10px; margin-top: 15px;"></i>Button <small> Input Nilai Kurikulum</small></h3>
    ...
    <script>
        ...
        function editAndShow(iv, id) {
            $.ajax({
                url: "/buttoninputnilaikurikulum-edit1/" + id,
                type: "GET",
        ...
        function saveChanges() {
            ...
            $.ajax({
                url: "/buttoninputnilaikurikulum-save",
                type: "POST",
                data: data,
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var table = $('.user_datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('buttoninputnilaikurikulum.index2') }}",
                    method: "GET"
                },
                columns: [{
                        data: 'id',
