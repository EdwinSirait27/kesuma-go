<div class="row" id="hal_edit" style="display: none;">
    <div class="col-md-12 col-sm-12">
        <div class="dashboard_graph">
            <h2><i class="fa fa-futbol-o" style="margin-right: 10px;"></i>Edit Button Tanggal</h2>
            <hr>
           
            <form method="POST" action="/buttoninputnilaikurikulum-update3" onsubmit="return simpan()">
                @csrf
