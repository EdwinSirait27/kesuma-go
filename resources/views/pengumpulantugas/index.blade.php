...
@section('content')
@if (auth()->user()->hakakses == 'Admin'||auth()->user()->hakakses == 'KepalaSekolah'||auth()->user()->hakakses == 'Guru'||auth()->user()->hakakses == 'Kurikulum')
    ...
    <div class="row" id="hal_index">
        <div class="card-header bg-dark text-white">
            <h3><i class="fa fa-users"style="margin-right: 10px; margin-top: 15px;"></i>Piiiengumpulan <small>Tugas</small></h3>
            <h5>Nama Guru : {{ $datakelasdatamengajar->datamengajar->guru->Nama}}</h5>
    ...
    <div class="x_panel">
        <div class="x_title">
            <h2><i class="fa fa-bar-chart" style="margin-right: 10px; "></i>Pengumpulan<small>Tugas</small></h2>
