@extends('index')
@section('title', 'Kesuma-GO | Data Kurikulum')
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="row g-3 align-items-center">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><i class="fa fa-calculator" style="margin-right: 10px; "></i>Data Kurikulum<small>Sekolah</small></h2>
        ...
        $(document).on('click', '#bulk_delete', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    if (id.length > 0) {
                        $.ajax({
                            url: "{{ route('kurikulum.removeall') }}", // Hapus 'kurikulum_id' => ''
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                            },
                            method: "get",
                            data: {
                                kurikulum_id: id // Ganti 'kurikulum_id' dengan 'id_kur'
                            },
                            success: function(data) {
                                console.log(data);
                                Swal.fire({
                                ...
                                window.location.assign("kurikulum");
                            },
                            error: function(data) {
