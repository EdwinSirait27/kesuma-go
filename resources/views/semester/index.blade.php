@extends('index')
@section('title', 'Kesuma-GO | Data Semester')
@section('content')
...
.text-danger {
    ...
    <div class="row" id="hal_index">
        <div class="col-md-12 col-sm-12">
            <h3><i class="fa fa-calculator" style="margin-right: 10px; margin-top: 15px;"></i>Data  <small>Semester</small></h3>
            <hr>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="row g-3 align-items-center">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><i class="fa fa-calculator" style="margin-right: 10px; "></i>Data <small>Semester</small></h2>
        ...
        $(document).on('click', '#bulk_delete', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    if (id.length > 0) {
                        $.ajax({
                            url: "{{ route('semester.removeall') }}", // Hapus 'kurikulum_id' => ''
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                            },
                            method: "get",
                            data: {
                                semester_id: id // Ganti 'kurikulum_id' dengan 'id_kur'
                            },
                            success: function(data) {
                                console.log(data);
                                Swal.fire({
