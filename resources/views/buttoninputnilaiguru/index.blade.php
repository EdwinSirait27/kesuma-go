...
@section('content')
    @include('buttoninputnilaiguru.create')
    <style>
        .table th,
        .table td {
            text-align: center;
    ...
    <div class="row" id="hal_index">
        <div class="card-header bg-dark text-white">
            <h3><i class="fa fa-book"style="margin-right: 10px; margin-top: 15px;"></i>Button <small> Input Nilai Guru</small></h3>
    ...
    <script>
        ...
        function editAndShow(iv, id) {
            $.ajax({
                url: "/buttoninputnilaiguru-edit1/" + id,
                type: "GET",
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var table = $('.user_datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('buttoninputnilaiguru.index2') }}",
                    method: "GET"
                },
                columns: [{
                        data: 'id',
