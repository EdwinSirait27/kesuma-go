<div class="row" id="hal_edit"style="display: none;">
    <div class="col-md-12 col-sm-12">
        <div class="dashboard_graph">
            ...
            <hr>
            <form method="POST" action="/editdatasiswa-update"enctype="multipart/form-data" onsubmit="return simpan()">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="text" class="form-control" id="NamaLengkap" name="NamaLengkap"
                            placeholder="Nama Lengkap" maxlength="30" required oninput="validateInput(this)"required>
                    </div>
                </div>
                <script>
    ...
    <div class="form-group row">
            ...
            <label for="Kab_KotaSMP" class="col-sm-2 col-form-label">Kabupaten/Kota SMP</label>
            <div class="col-sm-4">
  ...
  <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input type="TamatBelajarTahun" class="form-control" id="TamatBelajarTahun"
                name="TamatBelajarTahun" placeholder="Tamat Belajar SMA Tahun"  oninput="this.value = this.value.replace(/[^0-9]/g, '');" maxlength="4">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input type="username" class="form-control" id="username" name="username" placeholder="Username"readonly>
