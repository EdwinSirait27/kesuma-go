@extends('index')
@section('title', 'Kesuma-GO | Edit Profile Guru')
@section('content')
<style>
    .dashboard_graph {
        padding: 20px;
            ...
            <div class="card">
                <div class="card-header bg-dark text-white">
                    <h3 style="display: flex; align-items: center;">
                        ...
                        <a href="/editpasskepalasekolah" class="btn btn-success">Ganti Password</a>
                ...
                <form method="POST" action="{{ route('editprofileKepalaSekolah.update') }}" enctype="multipart/form-data">
                    ...
                    <a href="/KepalaSekolahBeranda" class="btn btn-danger">Kembali</a>
                        </div>
