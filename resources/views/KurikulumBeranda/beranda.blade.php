        ...
        <div class="row" style="display: inline-block;">
            <div class="tile_count">
                <div class="col-md-4 col-sm-4 tile_stats_count">
                    ...
                    <span class="count_bottom"><i class="green"></i>{{ $totalLakiLaki }} </i> Siswa Laki-Laki</span>
                </div>
                <div class="col-md-4 col-sm-6 tile_stats_count">
                    ...
                    <span class="count_bottom"><i class="red"></i>{{ $totalPerempuan }} </i> Siswa Perempuan</span>
                </div>
                <div class="col-md-4 col-sm-6 tile_stats_count">
                    <span class="count_top"><i class="fa fa-user"></i> Total Guru dan Staff</span>
                    <div class="count">{{ $totalGuru }}</div>
                    <span class="count_bottom"><i class="green"></i>{{ $totalGuru }}</i> Total Guru dan Staff</span>
                </div>
            </div>
        </div>
        <hr>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
             var table = $('.user_datatable').DataTable({
                 ...
                 serverSide: true,
                 ajax: {
                     url: "{{ route('KurikulumBeranda.index2') }}",
                     method: "GET"
                 },
                 columns: [
                     {
             ...
             $('body').on('click', '.btn-preview', function() {
                 ...
                 var url = "{{ route('KurikulumBeranda.preview', ':dokumen') }}";
