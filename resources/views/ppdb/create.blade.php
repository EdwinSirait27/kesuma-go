...
<div class="container" id="hal_edit" style="display: none;">
    <div class="row">
        <div class="col-12">
            <div class="dashboard_graph">
                <h3 style="color: black;">
                    <i class="fa fa-male" style="margin-right: 4px; margin-top: 15px;"></i>Edit <small>Siswa</small>
                  </h3>
                ...
                <form method="POST" action="/ppdb-update2" enctype="multipart/form-data" onsubmit="return simpan()">
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="input-group">
                            <input type="password" class="form-control" name="password" id="password" placeholder="Password" maxlength="12" disabled>
                        ...
                        <div class="col-sm-4">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="updatePasswordCheckbox" name="updatePasswordCheckbox">
                                <label class="form-check-label" for="updatePasswordCheckbox">Update Password</label>
                            </div>
                        </div>
                        <h8 style="color: red;">*Minimal 7 karakter,Maksimal 12 Karakter bebas, Tidak mengandung spasi</h8>
<!--                        <script>-->
<!--    document.getElementById("updatePasswordCheckbox").addEventListener("change", function() {-->
<!--        var passwordInput = document.getElementById("password");-->
<!--        passwordInput.disabled = !this.checked; // Mengaktifkan/menonaktifkan input password berdasarkan status checkbox-->
<!--        if (!this.checked) {-->
<!--            passwordInput.value = ''; // Mengosongkan input password jika checkbox tidak dicentang-->
<!--        }-->
<!--    });-->
<!--</script>-->
                                <br>
                                <br>
                                <label for="NamaLengkap" class="col-form-label">Nama
                                    Lengkap</label>
                                <input type="text" class="form-control" id="NamaLengkap" name="NamaLengkap"
                                    placeholder="Nama Lengkap" maxlength="30" required oninput="validateInput(this)">
                                ...
                                <label for="TanggalLahir" class="col-form-label">Tanggal
                                    Lahir</label>
                                <input type="date" class="form-control" id="TanggalLahir" name="TanggalLahir"
                                    placeholder="Tanggal Lahir" required>
                                <label for="NomorTelephone" class="col-form-label">Nomor
                                    Telepon</label>
                                ...
                                <label for="AsalSMP" class="col-form-label">Asal
                                    SMP</label>
                                <input type="text" class="form-control" id="AsalSMP" name="AsalSMP"
                                    placeholder="Asal SMP" maxlength="30" required>
                                <label for="NomorTelephoneAyah" class="col-form-label">Nomor Telepon Ayah</label>
                                <input type="text" class="form-control" id="NomorTelephoneAyah"
                                    name="NomorTelephoneAyah" placeholder="Nomor Telepon Ayah"
                                    oninput="this.value = this.value.replace(/[^0-9]/g, '');" maxlength="13" required>
                                <label for="NamaAyah" class="col-form-label">Nama
                                    Ayah</label>
                                <input type="text" class="form-control" id="NamaAyah" name="NamaAyah"
                                    placeholder="Nama Ayah" maxlength="30" required>
                                <label for="cita" class="col-form-label">Cita - Cita
                                </label>
                                <input type="text" class="form-control" id="cita" name="cita"
                                    placeholder="Cita - Cita" maxlength="30" required>
                                <label for="foto" class="col-form-label">Foto
                                    Siswa</label>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-4">
                            ...
                            <button type="button" onclick="window.location.href = '{{ url('/ppdb') }}'"
                                class="btn btn-danger">Kembali</button>
                        </div>
                    </div>
                    <div class="row">
                        <p style="color: red;">*Kalau Mengedit Data, Wajib untuk mengganti password default 2000000 dan Jangan Lupa Untuk Mengisi
                            CheckBox dan Mengganti Passwordnya (jikalau calon siswa lupa password)</p>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="dashboard_graph">
                ...
                <form method="POST" action="/ppdb-update2" enctype="multipart/form-data" onsubmit="return simpan()">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-4">
                            <button type="submit" class="btn btn-primary">Simpan</button>
                            <button type="button" onclick="window.location.href = '{{ url('/ppdb') }}'" class="btn btn-danger">Kembali</button>
                        </div>
                    </div>
                    <div class="row">
                        <p style="color: red;">*Kalau Mengedit Data atau Menambah Data, Jangan Lupa Untuk Mengisi CheckBox dan Mengganti Passwordnya</p>
                    </div>
                </form>
            </div>
        </div>
