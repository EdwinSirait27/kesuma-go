        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="dashboard_graph">
                    ...
                    <hr>
                    <form method="POST" id="editPasswordForm" action="{{ route('editpasskepalasekolah.updateee') }}">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <button type="button" onclick="window.location.href = '/editprofileKepalaSekolah'"
