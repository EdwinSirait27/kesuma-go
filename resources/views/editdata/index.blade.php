...
@section('content')
   ...
   <div class="row" id="hal_index">
    <div class="card-header bg-dark text-white">
        <h3><i class="fa fa-book"style="margin-right: 10px; margin-top: 15px;"></i>Button <small> Edit Data Siswa</small></h3>
