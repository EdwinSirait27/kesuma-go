...
class editprofileControllerKurikulum extends Controller
{
    public function index()
    {
        ...
        return view('editprofileKurikulum.index', compact('guru', 'akunguru', 'availableRoles'));
    }
    public function update(Request $request)
    {
        ...
        return redirect('/editprofileKurikulum')->with('success', 'Profil berhasil diperbarui!');
    }
    public function indexx()
    {
        ...
        return view('editpasskurikulum.index', compact('guru', 'akunguru', 'availableRoles'));
    }
    public function updatee(Request $request)
    {
        ...
        if ($request->has('password') && !Hash::check($request->input('password'), $akunguru->password)) {
            ...
            return redirect('/editpasskurikulum')->with('success', 'Edit Password berhasil diperbarui!');
        } else {
            return redirect('/editpasskurikulum')->with('warning', 'Tidak ada perubahan data');
        }
    }
}
