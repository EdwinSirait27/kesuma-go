...
class editprofileControllerGuru extends Controller
{
    public function index()
    {
        ...
        return view('editprofileGuru.index', compact('guru', 'akunguru', 'availableRoles'));
    }
    public function update(Request $request)
    {
        ...
        return redirect('/editprofileGuru')->with('success', 'Profil berhasil diperbarui!');
    }
    public function indexx()
    {
        ...
        return view('editpassguru.index', compact('guru', 'akunguru', 'availableRoles'));
    }
    public function updatee(Request $request)
    {
        ...
        if ($request->has('password') && !Hash::check($request->input('password'), $akunguru->password)) {
            ...
            return redirect('/editpassguru')->with('success', 'Edit Password berhasil diperbarui!');
        } else {
            return redirect('/editpassguru')->with('warning', 'Tidak ada perubahan data');
        }
    }
}
